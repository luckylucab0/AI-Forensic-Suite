...
| [0032](0032-a-database-without-its-log-is-a-gap-not-a-silence.md) | A SQLite store collected without its write-ahead log is recorded as a gap, where the catalogue never asked for one |
